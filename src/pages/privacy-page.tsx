  ...
  return (
    <main>
      ...
      <PageContent>
        {
          <>
            <p className = "flex justify-center  m-0">Last updated: </p> 
            <p className = "flex justify-center  m-0"> February 06, 2025</p>
            <p className = "m-0">
            ...
            <h2 className = "flex justify-center ">Interpretation and Definitions</h2>
            ...
            <h4>Definitions:</h4>
            <h3>For the purposes of this Privacy Notice:</h3>
            <ul>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to GDSC CSUSM, 333
                  S. Twin Oaks Valley Rd. San Marcos, CA 92096-0001 .
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to GDSC CSUSM, accessible from{" "}
                  <a
                    href="https://gdsc-csusm.com/"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://gdsc-csusm.com/
                  </a>
                </p>
              </li>
              <li>
            ...
            <h2 className = "flex justify-center  ">Collection and Usage of Your Personal Data</h2>
            <h3 className = "flex justify-center  ">Types of Data Collected:</h3>
            <h4>Personal Data:</h4>
            <p>
            ...
            <h4 className = "flex justify-center ">Information from Third-Party Social Media Services</h4>
            <p>
            ...
            <h4 className = "flex justify-center  ">Tracking Technologies and Cookies</h4>
            <p>
            ...
            <h3 className = "flex justify-center ">Disclosure of Your Personal Data</h3>
            ...
            <h2 className = "flex justify-center  ">Links to Other Websites</h2>
            <p>
            ...
            <h2 className = "flex justify-center ">Changes to this Privacy Policy</h2>
            <p>
            ...
            <ul>
              <li>
                ...
                <a
                  href="https://gdsc-csusm.com/contact-us"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://gdsc-csusm.com/contact-us
                </a>
              </li>
            </ul>
          </>
