  ...
  return (
    <main>
      <PageHeader
        ...
        subTitle="Last updated: February 06, 2025"
        backgroundImageSrc="/images/placeholder/homeBackground-4.jpg"
      />
      <PageContent>
        <div className="wrapper text-justify">
          <div className="my-[24px]" id="legal-terms">
            <div>
              <div>
                <strong>
                  <span>
                    <h2 className="font-bold">AGREEMENT TO OUR LEGAL TERMS</h2>
                  </span>
                </strong>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                <span>
                  ...
                  Legal Terms at any time and for any reason . We will alert you
          ...
          <div className="my-[24px]" id="services">
            <h2 className="font-bold">1. OUR SERVICES</h2>
            <p>
          ...
          <div className="my-[24px]" id="intellectual-property-right">
            <div className="title">
            ...
            <div>
              ...
              <div>
                <span>
                  ...
                  unfair competition laws) and treatiesaround the world.
                </span>
              </div>
              <div>
                {" "}
          ...
          <div className="my-[24px]" id="user-representation">
            <h2 className="font-bold">3. USER REPRESENTATIONS</h2>
            <p>
              ...
              applicable law or regulation. If you provide any information that
          ...
          <div className="my-[24px]" id="user-registation">
            <h2 className="font-bold">4. USER REGISTATION</h2>
            <p>
          ...
          <div className="my-[24px]" id="prohibited-activities">
            <h2 className="font-bold">5. PROHIBITED ACTIVITIES</h2>
            <p>
            ...
            <ul>
              ...
              <li>
                Except as permitted by law, decipher, decompile, disassemble, or
          ...
          <div className="my-[24px]" id="user-genrated-contribution">
            <h2 className="font-bold">6. USER GENRATED CONTRIBUTIONS</h2>
            <p>
            ...
            >
              ...
              <li>
                ...
                childpornography, or otherwise intended to protect the health or
                well-being of minors.
              </li>
              <li>
                Your Contributions do not include any offensive comments that
                are connected that are connected to race, national origin,
          ...
          <div className="my-[24px]" id="license">
            <h2 className="font-bold">7. CONTRIBUTION LICENSE</h2>
            <p>
          ...
          <div className="my-[24px]" id="site-manage">
            <h2 className="font-bold">8. SERVICES MANAGEMENT</h2>
            <p>
          ...
          <div className="my-[24px]" id="ppno">
            <h2 className="font-bold">9. PRIVACY POLICY</h2>
            <p>
          ...
          <div className="my-[24px]" id="terms">
            <h2 className="font-bold">10. TERM AND TERMINATION</h2>
            <p>
          ...
          <div className="my-[24px]" id="modification">
            <h2 className="font-bold">11. MODIFICATIONS AND INTERRUPTIONS</h2>
            <p>
          ...
          <div className="my-[24px]" id="disputes">
            <h2 className="font-bold">13. DISPUTE RESOLUTION</h2>
          ...
          <div className="my-[24px]" id="corrections">
            <h2 className="font-bold">14. CORRECTIONS</h2>
            <p>
          ...
          <div className="my-[24px]" id="disclaimer">
            <h2 className="font-bold">15. DISCLAIMER</h2>
            <p>
          ...
          <div className="my-[24px]" id="liability">
            <h2 className="font-bold">16. LIMITATIONS OF LIABILITY</h2>
            <p>
          ...
          <div className="my-[24px]" id="indemnification">
            <h2 className="font-bold">17. INDEMNIFICATION</h2>
            <p>
          ...
          <div className="my-[24px]" id="user-data">
            <h2 className="font-bold">18. USER DATA</h2>
            <p>
          ...
          <div className="my-[24px]" id="electronic">
          ...
          <div className="my-[24px]" id="msic">
            <h2 className="font-bold">20. MISCELLANEOUS</h2>
            <p>
          ...
          <div className="my-[24px]" id="contact">
            <h2 className="font-bold">21. CONTACT US</h2>
            <p>
